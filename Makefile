...
Chip8Emu :
	$(CXX) $(CXXFLAGS) -I$(wxIPath) -I$(wxIMSWU) $(defines) $(wxLib) -c src/Core/Chip8.cpp -o bin/obj/Chip8.o
	...
	$(CXX) $(CXXFLAGS) -I$(wxIPath) -I$(wxIMSWU) $(defines) $(wxLib) -c src/Chip8Emu.cpp -o bin/obj/Chip8Emu.o
	$(CXX) $(CXXFLAGS) -I$(wxIPath) -I$(wxIMSWU) $(defines) $(wxLib) -c src/Main.cpp -o bin/obj/Main.o
	$(CXX) $(linkerFLAGS) -L$(wxLibPath) $(obj) $(wxLib) -o bin/Chip8Emu.exe
